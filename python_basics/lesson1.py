...
name= "Alice" # This is an string variable
...
# Integer variables are used to store the whole numbers.
...
hobby = "painting"
city = "New York"
#print a sentance using all the variables above using f-strings
print(f"My name is {name}, I am {mood} and live in {city}.")
print(f"Today is {date} and the weather is {weather}.")
print(f"Today I will {hobby} in {city}.")
